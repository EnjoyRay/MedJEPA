...
> Exp1 ????????? AUROC?AUROC drop ? cosine drift????? JEPA300 ???????????????????????????????????????????
...
> NCA ????????? loss?JEPA300 ??????????? raw encoder drift ? adapter output drift ??????
...
> Per-sample ????? JEPA300 ????????????????????????????????lesion-control delta ??????? MAE300 ????
...
> Exp4 per-sample scatter ? token ??????????????????????????JEPA300 ??????? lesion drift ??MAE300 ???????????
